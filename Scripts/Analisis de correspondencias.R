...
data_pcm_dep$civil<-factor(data_pcm_dep$civil)
data_pcm_dep$health<-factor(data_pcm_dep$health)
data_pcm_dep$salario<-factor(data_pcm_dep$salario) ## Puede que el problema esté aquí
data_pcm_dep$comuna<-factor(data_pcm_dep$comuna) ## Falta cambiar el numero por las comunas
data_pcm_dep$region<-factor(data_pcm_dep$region)
data_pcm_dep$grupo_etario<-factor(data_pcm_dep$grupo_etario)
...
data_pcm_des$health<-factor(data_pcm_des$health)
data_pcm_des$salario<-factor(data_pcm_des$salario)
data_pcm_des$comuna<-factor(data_pcm_des$comuna) ## Falta cambiar el numero por las comunas
data_pcm_des$region<-factor(data_pcm_des$region)
data_pcm_des$grupo_etario<-factor(data_pcm_des$grupo_etario)
#Revisando los datos
...
data_pcm_mar$health<-factor(data_pcm_mar$health)
data_pcm_mar$salario<-factor(data_pcm_mar$salario)
data_pcm_mar$comuna<-factor(data_pcm_mar$comuna) ## Falta cambiar el numero por las comunas
data_pcm_mar$region<-factor(data_pcm_mar$region)
data_pcm_mar$grupo_etario<-factor(data_pcm_mar$grupo_etario)
#Revisando los datos
...
data_pcm_kin$health<-factor(data_pcm_kin$health)
data_pcm_kin$salario<-factor(data_pcm_kin$salario)
data_pcm_kin$comuna<-factor(data_pcm_kin$comuna) ## Falta cambiar el numero por las comunas
data_pcm_kin$region<-factor(data_pcm_kin$region)
data_pcm_kin$grupo_etario<-factor(data_pcm_kin$grupo_etario)
#Revisando los datos
...
dev.off()
>>>>>>> 0d91b9fa765df2f1c23ee4e3bfb725fc75ca8bf3
