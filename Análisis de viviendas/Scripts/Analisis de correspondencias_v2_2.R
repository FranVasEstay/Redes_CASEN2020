...
################################################################################
### Versión 2.2 ###
## MCA usando sólo datos descriptivos de las redes categorizados
...
mca_data <- network_data_categorized %>%
