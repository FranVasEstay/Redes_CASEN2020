x <- 1101102107 #ingresamos el household_id de una vivienda en la que estamos interesados
...
View(filter(data_ergomitos,household==110110210701))
...
plot(kinship_igrpah[159][[1]]$kinship_net)
plot(kinship_igraph_no_attrs[159][[1]]$kinship_net)
