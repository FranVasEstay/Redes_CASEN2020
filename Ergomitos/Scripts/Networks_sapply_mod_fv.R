...
save(kinship_igrpah_sample, file = paste0(getwd(), "/Ergomitos/Redes/kinship_igrpah.RData"))
...
save(kinship_network_sample, file = paste0(getwd(), "/Ergomitos/Redes/kinship_network.RData"))
